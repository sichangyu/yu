...
const ToDoList = (props) => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.headerText}> Record of your dose history </Text>
      <View>
        <TextInput
          style={{height: 20}}
          placeholder="Enter time for first dose here"
          onChangeText={text => {
               setTodo(text);
             }}
          value = {todo}
      ...
      <View>
        <TextInput
          style={{height: 20}}
          placeholder="Enter time for second dose here"
          onChangeText={text => {
               setDueDate(text);
             }}
          value = {dueDate}
      ...
      <View>
        <TextInput
          style={{height: 20}}
          placeholder="Enter  time for third dose here"
          onChangeText={text => {
               setComment(text);
             }}
          value = {comment}
